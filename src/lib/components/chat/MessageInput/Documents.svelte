...
{#if filteredItems.length > 0 || prompt.split(' ')?.at(0)?.substring(1).startsWith('http')}
	<div class="md:px-2 mb-3 text-left w-full absolute bottom-0 left-0 right-0" style="display:notificationEnabled">
		<div class="flex w-full px-2" style="display:none">
